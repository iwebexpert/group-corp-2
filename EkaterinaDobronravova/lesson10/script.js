...
document.addEventListener('DOMContentLoaded', () => {
  ...
  deleteProduct(product){
    ...
    createBasket(){
      ...
      basketContainer.classList.add('basket_container')
        if (this.products.length === 0){
          ...
          basket.innerHTML = `В корзине <b>${this.products.length}</b> товаров на сумму <b>${this.totalPriceBasket()}</b>`;
          basketContainer.appendChild(basket);
    ...
    let keyboard = new Product(1, 'Keyboard', '1000', ["./img/keyboard.jpg"]);
    let mouse = new Product(2, 'Mouse', '2000', ["./img/mouse.jpg"]);
    let gamepad = new Product(3, 'Gamepad', '3000', ["./img/gamepad.jpg"]);
