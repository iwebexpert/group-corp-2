...
class Board {
    ...
    public getSnakeBodyElements(bodyCoords: Array<coordination> = []): Array<HTMLTableDataCellElement> | null {
    ...
    public isNextStepWall(nextSnakeCoords: coordination): boolean {
        let nextCell = this.getCell(nextSnakeCoords.x, nextSnakeCoords.y);
        return nextCell === null;
    }

    //Еда на игровом поле (добавление)
    public renderFood(coords: coordination): void {
