...
export default class Settings {
    private readonly defaultParams: SettingsStruct = {
        rowsCount: 20,
        colsCount:20,
        speed: 4,
        winLength: 5,
    ...
    private readonly gameParams: SettingsStruct;

    constructor(params?: SettingsStruct) {
    ...
    public getParams(): SettingsStruct{
