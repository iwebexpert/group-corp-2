...
//Задание 1 
// Основной проблемой для меня оказалось сделать цифры и буквы. Наверное, решение слишком громоздкое в виду использования кучи переменных (и возможно лишних манипуляций).
//Самым логичным решением для меня показалось сначала отрисовать один большой стол внутри которого отдельно будут отрисовываться его составные элементы.
