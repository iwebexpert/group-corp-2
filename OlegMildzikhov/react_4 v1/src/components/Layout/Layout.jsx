...
export  class Layouts extends Component {
    ...
    //         const index = this.props.location.pathname.substring(7);
    //         const upMess = chats[index].messages;
    //         const upInfo = chats[index].info[0];
    //         this.setState(({messages})=> {
    //             return {
    //                 messages: upMess
    //             }
    //         })
    //         console.log(this.props.location, upMess, upInfo);
    //     }
  ...
  addItem(body) {
    ...
    render() {
        ...
        onAdd={this.addItem}/>
                    ...
                    <div className={'sfs'}>
                    <Switch>
                        <Route path="/chats/:id([0-9]+)" render={(props) => <Messenger {...props} name={chatsList} />}
                               exact></Route>
