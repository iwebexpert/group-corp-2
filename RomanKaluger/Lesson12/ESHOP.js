class SizeAndToppingSelector{
    constructor(productGroupItem, productPriceLabel){
...
class InitializatorDOM {
    ...
    createCatalogCard(productGroupItem, mode) {
        ...
        const toppingsSelector = new SizeAndToppingSelector(productGroupItem, productPrice);
...
class ProductToEat extends Product{
    ...
    get price() {
        return this._price * ProductToEat.getSizeMultiplier({size: this._size}) + this._ingredientsArr.reduce((acc, val) => acc + val.price, 0);
    }
    getBasePrice() {
        return  this._price;
    }
...
const pr1 = new ProductToEat('Хачапури', 100, 'Пальчики оближешь', '100g',
    ...
    ], [], ProductToEat.productSizes.MEDIUM, 100);
const pr2 = new ProductToEat('Шашлык', 200, 'Не из собак', '100g',
    ...
    ], [], ProductToEat.productSizes.MEDIUM, 200);
const pr3 = new ProductToEat('Шаурма', 150, 'Не из кошек', '100g',
    ...
    ],[], ProductToEat.productSizes.MEDIUM, 150);
const pr4 = new ProductToEat('Котяра', 1, 'Осторожно, кот', '100g',
    ...
    ],[], ProductToEat.productSizes.MEDIUM, 120);
