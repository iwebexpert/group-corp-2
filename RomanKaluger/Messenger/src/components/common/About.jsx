...
export const About = () => {
    const {aboutPageOpen} = useSelector(s => s.system);
        ...
        <Backdrop open={aboutPageOpen}>
            <div className={'AboutContainer'}>
                ...
                <ul>
                    ...
                    <li>Удаление чата</li>
                    <li>Создание чата с произвольным пользователем</li>
                    ...
                    <li>Просмотр информации о пользователе(клик на его карточке или автарке в шапке чата)</li>
