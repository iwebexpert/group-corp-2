...
export const setForwardMessage: ActionFunction1<ISetFrowardMessagePayload, ISetForwardMessage> = createAction('SET_FORWARD_MESSAGE');
...
export const setError: ActionFunction1<Partial<Error>,ISetError> = createAction('ERROR');
