...
import {IChat, IContacts, IMessage, IUser} from "../../types/globalTypes";
...
export interface IAuth<T extends HTMLFormControlsCollection = IInputAuth> extends CommonAction {
    payload: T;
}
