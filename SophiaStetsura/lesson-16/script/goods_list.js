...
class Cart {
    ...
    render() {
        ...
        this.goods.forEach((cartItem, indexOfProduct) => {
            // const goodItem = new CartItem(cartItem.title, cartItem.price, cartItem.src, cartItem.quantity)
            // listHtml += goodItem.renderWithIndex(indexOfProduct);
...
const addItemToCart = () => {
    ...
    const cartItem = allProducts.items.find((it) => it.title === productName);
    // allProducts.items.forEach((i) => {
    //     console.log(i.title);
    //     console.log(i.title == productName);
    // });
    // console.log(allProducts.items, productName, cartItem);
